...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition: 'Documento técnico que apresenta os critérios, fórmulas e resultados usados para dimensionar um projeto, servindo de base técnica e de consulta para quem revisa ou aprova o trabalho.',
  },
  {
    term: 'Offtracking',
  ...
  {
    term: 'OpenBIM / IFC',
    definition: 'Padrão aberto de modelagem de informação da construção (BIM) que permite a troca de dados entre softwares diferentes através do formato IFC, sem depender de uma única plataforma proprietária.',
  },
  {
  ...
  },
  {
    ...
    definition: 'Levantamento técnico que registra tanto a posição horizontal (planimetria) quanto as diferenças de altura (altimetria) de um terreno, servindo de base para praticamente todo projeto de infraestrutura civil.',
  },
  {
