...
export const translations = {
  pt: {
    ...
    porque: {
      ...
      body2: 'Atendemos obras em todo o Brasil, com sede em Campinas e visita técnica quando o projeto exige. Acesso direto ao engenheiro responsável, cronograma definido e documentação técnica sem camadas desnecessárias.',
      stats: [
      ...
      diferenciais: [
        ...
        'Cronograma real, definido em contrato e não em estimativa comercial',
        'Modular e flexível, adaptado ao escopo e ao prazo do seu projeto',
        'Confidencialidade garantida para parceiros B2B e B2C',
        'Atendimento em todo o Brasil, com sede em Campinas (SP)',
      ],
    },
    salatecnica: {
      eyebrow: 'Sala Técnica',
      title: 'A Sala Técnica da PER5',
      lead: 'Sala Técnica é o backoffice de engenharia civil da PER5. Um time técnico sob demanda que entra no seu projeto como consultor, revisor ou especialista, sem custo fixo mensal e sem que você precise montar equipe interna.',
      roles: [
        {
          title: 'Consultor',
          desc: 'Apoio técnico para a decisão que ainda não foi tomada: viabilidade, alternativas de solução, ordem de grandeza de volume e o caminho de aprovação junto aos órgãos.',
          trigger: 'Quando a decisão técnica ainda está em aberto.',
        },
        {
          title: 'Revisor',
          desc: 'Segunda leitura de um projeto que já existe: compatibilização entre disciplinas, conferência de memorial e dimensionamento, checagem antes do protocolo.',
          trigger: 'Quando o projeto já existe e precisa de conferência.',
        },
        {
          title: 'Especialista',
          desc: 'Execução da disciplina que falta no seu time: terraplenagem, drenagem, pavimentação ou urbanismo, entregue compatibilizado e com ART.',
          trigger: 'Quando falta uma disciplina específica no seu time.',
        },
      ],
      badges: [
        'Confidencialidade garantida',
        'ART em todas as entregas',
        'Sem custo fixo mensal',
        'Sob demanda ou por pacote',
      ],
      ctaPrimary: 'Falar sobre a Sala Técnica',
      ctaSecondary: 'Como a Sala Técnica funciona',
      note: 'Seu cliente continua sendo seu cliente. Sua assinatura no projeto, nossa entrega técnica.',
    },
    paraquem: {
      eyebrow: 'Para quem',
      ...
      segments: [
        {
          ...
          link: { to: '/engenharia-civil/para/construtoras', label: 'Engenharia civil para construtoras' },
        },
        {
          tab: 'Indústrias',
          ...
          cta: 'Solicitar Orçamento de Projeto',
          link: { to: '/engenharia-civil/para/industrias', label: 'Engenharia civil para indústrias' },
        },
        {
          tab: 'Loteadoras',
          ...
          cta: 'Solicitar Orçamento de Projeto',
          link: { to: '/engenharia-civil/para/loteadoras', label: 'Engenharia civil para loteadoras' },
        },
        {
          tab: 'Escritórios',
          title: 'Escritórios de Arquitetura e Engenharia',
          pitch: 'A Sala Técnica que completa o seu atendimento.',
          body: 'Você tem o cliente. Tem o relacionamento. Mas o projeto pede terraplenagem, drenagem ou infraestrutura viária, e você não quer estruturar uma equipe interna para isso. A Sala Técnica da PER5 é o seu backoffice de engenharia: confidencialidade garantida, entrega compatibilizada, sua assinatura no projeto.',
          cta: 'Falar sobre parceria →',
          link: { to: '/engenharia-civil/para/escritorios-de-arquitetura', label: 'Parceria com escritórios de arquitetura' },
        },
      ],
      segLabel: 'Segmento',
    },
    ...
    cta: {
      ...
      placeholders: {
        ...
        empresa: 'Opcional', localizacao: 'Cidade e estado da obra',
      ...
      tipoProjeto: ['Projeto de Terraplenagem','Projeto de Drenagem Pluvial','Terraplenagem + Drenagem (integrado)','Projeto Urbanístico','Pavimentação','Regularização de Imóveis / Loteamento','Consultoria em Patologias','Topografia','Sala Técnica (backoffice de engenharia)','Revisão de projeto de terceiros','Consultoria / Outros'],
    ...
    contact: {
      ...
      crea: 'Registro profissional: <strong>CREA-SP</strong>. Todos os projetos são entregues com ART inclusa.',
    },
    footer: {
      tagline: 'Engenharia que facilita.',
      about: 'Escritório independente especializado em projetos de infraestrutura civil: terraplenagem, drenagem e pavimentação. Sede em Campinas, SP, com atendimento em todo o Brasil.',
      services: 'Serviços',
      forWhom: 'Para quem',
      contact: 'Contato',
      ...
      location: 'Sede em Campinas, SP · Atendemos todo o Brasil',
  ...
  en: {
    ...
    hero: {
      ...
      sub: 'PER5 delivers earthmoving, drainage, paving and urban planning designs with technical rigor and agility. You speak directly with the responsible engineer, with no intermediaries.',
    ...
    porque: {
      ...
      body2: 'We serve projects across Brazil, headquartered in Campinas, with site visits whenever the project calls for one. Direct access to the responsible engineer, defined schedules and technical documentation without unnecessary layers.',
      stats: [
      ...
      diferenciais: [
        ...
        'Real schedule, defined in contract and not in commercial estimates',
        'Modular and flexible, adapted to your scope and timeline',
        'Guaranteed confidentiality for B2B and B2C partners',
        'Nationwide service in Brazil, headquartered in Campinas (SP)',
      ],
    },
    salatecnica: {
      eyebrow: 'Sala Técnica',
      title: 'The PER5 Sala Técnica',
      lead: 'Sala Técnica is the PER5 civil engineering back-office. An on-demand technical team that joins your project as consultant, reviewer or specialist, with no fixed monthly cost and no internal team for you to build.',
      roles: [
        {
          title: 'Consultant',
          desc: 'Technical support for the decision that has not been made yet: feasibility, alternative solutions, order of magnitude for earthwork volumes and the approval path with public agencies.',
          trigger: 'When the technical decision is still open.',
        },
        {
          title: 'Reviewer',
          desc: 'A second reading of a design that already exists: cross-discipline compatibility, review of calculations and technical reports, a final check before submission.',
          trigger: 'When the design exists and needs verification.',
        },
        {
          title: 'Specialist',
          desc: 'Delivery of the discipline missing from your team: earthmoving, drainage, paving or urban design, fully compatible with the rest of the project and with ART.',
          trigger: 'When a specific discipline is missing from your team.',
        },
      ],
      badges: [
        'Guaranteed confidentiality',
        'ART on every delivery',
        'No fixed monthly cost',
        'On demand or by package',
      ],
      ctaPrimary: 'Talk about the Sala Técnica',
      ctaSecondary: 'How the Sala Técnica works (in Portuguese)',
      note: 'Your client stays your client. Your signature on the project, our technical delivery.',
    },
    paraquem: {
      eyebrow: 'For whom',
      ...
      segments: [
        {
          ...
          link: { to: '/engenharia-civil/para/construtoras', label: 'Civil engineering for builders (in Portuguese)' },
        },
        {
          tab: 'Industries',
          ...
          cta: 'Request Project Quote',
          link: { to: '/engenharia-civil/para/industrias', label: 'Civil engineering for industries (in Portuguese)' },
        },
        {
          tab: 'Developers',
          ...
          cta: 'Request Project Quote',
          link: { to: '/engenharia-civil/para/loteadoras', label: 'Civil engineering for land developers (in Portuguese)' },
        },
        {
          tab: 'Offices',
          title: 'Architecture & Engineering Firms',
          pitch: 'The Sala Técnica that completes your service.',
          body: "You have the client. You have the relationship. But the project calls for earthmoving, drainage or road infrastructure, and you don't want to build an internal team for that. The PER5 Sala Técnica is your engineering back-office: guaranteed confidentiality, compatible delivery, your signature on the project.",
          cta: 'Talk about partnership →',
          link: { to: '/engenharia-civil/para/escritorios-de-arquitetura', label: 'Partnership with architecture firms (in Portuguese)' },
        },
      ],
      segLabel: 'Segment',
    },
    ...
    cta: {
      ...
      placeholders: {
        ...
        empresa: 'Optional', localizacao: 'City and state of the project',
      ...
      tipoProjeto: ['Earthmoving Design','Stormwater Drainage Design','Earthmoving + Drainage (integrated)','Urban Design','Paving','Property / Subdivision Regularization','Pathology Consulting','Surveying','Sala Técnica (engineering back-office)','Third-party design review','Consulting / Other'],
    ...
    contact: {
      ...
      crea: 'Professional registration: <strong>CREA-SP</strong>. All projects are delivered with ART included.',
    },
    footer: {
      ...
      location: 'Based in Campinas, SP · Nationwide service in Brazil',
